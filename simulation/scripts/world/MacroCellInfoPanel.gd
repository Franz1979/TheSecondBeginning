...
@onready var geography_title_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/SectionTitleLabel
@onready var geography_info: CellGeographyInfo = $MarginContainer/VBoxContainer/GeografiaContent/CellGeographyInfo
@onready var space_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/SpaceLabel
@onready var stone_number_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/StoneNumberLabel
@onready var grass_number_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/GrassNumberLabel
@onready var shrub_number_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/ShrubNumberLabel
@onready var tree_number_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/TreeNumberLabel
@onready var resource_separator_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/ResourceSeparatorLabel
@onready var empty_space_label: Label = $MarginContainer/VBoxContainer/GeografiaContent/EmptySpaceLabel
